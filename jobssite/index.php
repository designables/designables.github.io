...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-3083466205193280",
    ...
    <nav id="topnav" class="navbar navbar-fixed-top navbar-default" role="navigation">
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <?php if (isset($jobaddlink) && $jobaddlink=='on'): ?>
                <ul class="nav navbar-nav navbar-right">
                     <li><a href="http://www.indeed.com/p/postjob.php?pid=<?php echo $indeed_publisher_id;?>" target="_blank"><i class="fa fa-plus-square"></i> Post a JOB</a></li>
...
<img src="/assets/img/slider4.jpg" alt="<?php echo $slide3_title; ?>" class="img-responsive">
    ...
    <section id="search">
        ...
        <p class="text-center"><?php echo _text('TEXT_SEARCH_ON'); ?></p>
                ...
                <?php if (isset($jobaddlink) && $jobaddlink=='on'): ?>
<p class="text-center">
                     <a href="http://www.indeed.com/p/postjob.php?pid=<?php echo $indeed_publisher_id;?>" target="_blank" class="btn btn-info btn-lg"><i class="fa fa-plus-square"></i> Post a JOB</a>
...
<p class="text-center lead" style="margin-bottom:70px;"><a href="#locations" class="btn btn-default btn-lg"><?php echo _text('HEADING_LOCATIONS'); ?></a> <a href="#categories" class="btn btn-default btn-lg"><?php echo _text('HEADING_CATEGORIES'); ?></a></p>
    ...
    <!-- ADS -->
    <div class="container">
        <div class="well well-lg text-center"><input type="hidden" name="IL_IN_TAG" value="1"/></div>
    </div>
    <!-- / ADS-->
                            ...
                            feed<?php echo $c; ?>.load(function(result) {
                                if (!result.error) {
                                    ...
                                    $.each(result.feed.entries, function(i, entry){
                                        ...
                                        div_innerHTML += '<p class="clearfix source"><span class="label label-default"> <?php echo $feed['title']; ?></span> <?php echo _text('PUBLISHED_ON'); ?> <span class="realdate">' + entry.publishedDate + '</span></p>';
                    ...
                    <?php
                        ...
                        if ( count($items) ){
                            ...
                            try{
                                ...
                                div_innerHTML += '<p class="clearfix source"><span class="label label-default"> <?php echo addslashes($feed['title']); ?></span> <?php echo _text('PUBLISHED_ON'); ?> <span class="realdate"><?php echo $entry['date']; ?></span></p>';
                                <?php if (isset($entry['company']) && isset($entry['city']) && isset($entry['state'])): ?>
                                div_innerHTML += '<p class="clearfix sourcecompany text-warning"><?php echo addslashes($entry['company']); ?> - <?php echo addslashes($entry['city']); ?>, <?php echo addslashes($entry['state']); ?></p>';
                                <?php endif; ?>
...
<div class="addthis_sharing_toolbox"></div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 col-lg-12">
                    <p> &copy; 2014 -2015 <?php echo _text('POWERED_BY'); ?> <a class="newsearch" href="<?php echo $siteurl;?>"><?php echo $contact_company_name;?></a> - Developed by <a href="http://www.scriptgeni.com" target="_blank" rel="nofollow">ScriptGeni</a></p>
                </div>
            </div>
        </div>
    </footer>
